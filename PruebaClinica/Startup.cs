...
using PruebaClinica.Repositories;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Threading.Tasks;

namespace PruebaClinica
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ClinicaContext>(options =>
                options.UseSqlServer(Configuration.GetConnectionString("Clinica"))
                );
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                app.UseExceptionHandler("/Medicamento/Error");
